...
import { OMNIDEF } from './fSC_SampleAccount_Opening_SampleEnglish_def.js';
import tmpl from './fSC_SampleAccount_Opening_SampleEnglish.html';
import tmpl_nds from './fSC_SampleAccount_Opening_SampleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fSC_SampleAccount_Opening_SampleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
